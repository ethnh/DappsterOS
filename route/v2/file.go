...
func (s *DappsterOS) GetFileTest(ctx echo.Context) error {
...
func (c *DappsterOS) CheckUploadChunk(ctx echo.Context, params codegen.CheckUploadChunkParams) error {
...
func (c *DappsterOS) PostUploadFile(ctx echo.Context) error {
