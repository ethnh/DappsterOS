...
import (
	...
	"github.com/dappster-io/DappsterOS/pkg/utils/version"
...
func GetSystemCheckVersion(ctx echo.Context) error {
	...
	if need {
		...
		installLog.Name = "DappsterOS System"
...
func GetDappsterOSErrorLogs(ctx echo.Context) error {
	...
	return ctx.JSON(common_err.SUCCESS, model.Result{Success: common_err.SUCCESS, Message: common_err.GetMsg(common_err.SUCCESS), Data: service.MyService.System().GetDappsterOSLogs(line)})
}
...
// @Summary get dappsteros server port
// @Produce  application/json
// @Accept application/json
// @Tags sys
// @Security ApiKeyAuth
...
// @Summary edit dappsteros server port
// @Produce  application/json
// @Accept application/json
// @Tags sys
// @Security ApiKeyAuth
...
// @Summary active killing dappsteros
// @Produce  application/json
// @Accept application/json
// @Tags sys
// @Security ApiKeyAuth
