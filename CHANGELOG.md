...
- [System] Fixed  not see wlan iface ([#909](https://github.com/dappster-io/DappsterOS/issues/909))
- [System] Terminal font issue fix ([#929](https://github.com/dappster-io/DappsterOS/issues/929))
...
- [Disk] Fix the problem of disk mount point plus 1 after upgrade ([#770](https://github.com/dappster-io/DappsterOS/issues/770))
- [File] Fix the problem of file permission change caused by modifying files in dappsteros ([#829](https://github.com/dappster-io/DappsterOS/issues/829))
- [Share] Fix the problem of files being deleted due to samba uninstallation failure ([#843](https://github.com/dappster-io/DappsterOS/issues/843))
...
- [System] Re-instate default zone0 for CPU Temp ([#694](https://github.com/dappster-io/DappsterOS/issues/694))
- [Disk] Fixed storage name with extra `-1` after rebooting ([#698](https://github.com/dappster-io/DappsterOS/issues/698))
- [Disk] Fixed disk check so it does not impact disk going into idle ([#704](https://github.com/dappster-io/DappsterOS/issues/704))
...
### Fixed
- [System] Fix CPU Temp for other platforms ([#661](https://github.com/dappster-io/DappsterOS/issues/661))

## [0.3.7.1] 2022-11-04

### Fixed

- Fix memory leak issue ([#658](https://github.com/dappster-io/DappsterOS/issues/658)[#646](https://github.com/dappster-io/DappsterOS/issues/646))
- Solve the problem of local application import failure ([#490](https://github.com/dappster-io/DappsterOS/issues/490))
...
### Fixed
- [Apps] Fixed the problem of not being able to modify some App settings ([#510](https://github.com/dappster-io/DappsterOS/issues/510))
...
- [App] fixed uninstalling imported docker container apps results in wiping ALL your config data from them ([#360](https://github.com/dappster-io/DappsterOS/issues/360))

## [0.3.4] - 2022-07-29(UTC)

### Added

- SSH adds port-side options and prompts for connection status. ([#286](https://github.com/dappster-io/DappsterOS/issues/286))

### Changed

- Normalize all routes
- Application names now support spaces ([#211](https://github.com/dappster-io/DappsterOS/issues/211))
...
- Fixed storage format and remove password error issues ([#344](https://github.com/dappster-io/DappsterOS/issues/344) [#357](https://github.com/dappster-io/DappsterOS/issues/357))
...
- Adding Developing file ([#311](https://github.com/dappster-io/DappsterOS/pull/311))
...
- [Disk] Fixed hard drive won't hibernate problem ([#202](https://github.com/dappster-io/DappsterOS/issues/202))
- [File] Fixed the backspace key that causes the folder to rewind ([#252](https://github.com/dappster-io/DappsterOS/issues/252))
- [App] Fixed app logo is not loading when imported. ([#320](https://github.com/dappster-io/DappsterOS/issues/320))
...
- [App] Fix the problem of application opening failure on non-80 ports ([#283](https://github.com/dappster-io/DappsterOS/issues/283) [#280](https://github.com/dappster-io/DappsterOS/issues/280))
- [System] Modify port failure problem ([#282](https://github.com/dappster-io/DappsterOS/issues/282))
- [App]Modify environment variables disappearing problem([#284](https://github.com/dappster-io/DappsterOS/issues/284))
- [System]Fix no update alert([#278](https://github.com/dappster-io/DappsterOS/issues/278))
- [System] Fixed some bugs of application cpu usage and memory staging([#272](https://github.com/dappster-io/DappsterOS/issues/272))
- [App] Fixed plex and HA network mode error issues ([#299](https://github.com/dappster-io/DappsterOS/issues/299))
- [App] Fix application terminal not working ([#266](https://github.com/dappster-io/DappsterOS/issues/266))
...
- [Apps] Support to modify the application opening address.([#204](https://github.com/dappster-io/DappsterOS/issues/204))

### Changed

- [Apps] Hide the display of non-essential environment variables in the application.([#196](https://github.com/dappster-io/DappsterOS/issues/196))
- [System] Network, disk, cpu, memory, etc. information is modified to be pushed via socket.
- [System] Optimize opening speed.([#214](https://github.com/dappster-io/DappsterOS/issues/214))
...
- [System] Fixed the problem that sync data cannot submit the device ID ([#68](https://github.com/dappster-io/DappsterOS/issues/68))
- [Files] Fixed the code editor center alignment display problem.([#210](https://github.com/dappster-io/DappsterOS/issues/210))
- [Files] Fixed the problem of wrong name when downloading files.([#240](https://github.com/dappster-io/DappsterOS/issues/240))
- [System] Fixed the network display as a negative number problem.([#224](https://github.com/dappster-io/DappsterOS/issues/224))
- [System] Fixed the problem of wireless network card traffic display.([#222](https://github.com/dappster-io/DappsterOS/issues/222))
