...
func (d *GoogleDrive) getRefreshToken() error {
	...
	res, err := base.RestyClient.R().SetResult(&resp).SetError(&e).
		SetFormData(map[string]string{
			...
			"redirect_uri":  "https://cloudoauth.files.dappsteros.app",
		}).Post(url)
	if err != nil {
		return err
	}
...
func GetConfig() GoogleDrive {
	...
	config.AuthUrl = "https://accounts.google.com/o/oauth2/auth/oauthchooseaccount?response_type=code&client_id=" + client_id + "&redirect_uri=https%3A%2F%2Fcloudoauth.files.dappsteros.app&scope=https%3A%2F%2Fwww.googleapis.com%2Fauth%2Fdrive&access_type=offline&approval_prompt=force&state=${HOST}%2Fv1%2Frecover%2FGoogleDrive&service=lso&o2v=1&flowName=GeneralOAuthFlow"
