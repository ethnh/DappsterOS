...
###
 ...
 # @FilePath: /DappsterOS/shell/delete-old-service.sh
 # @Description:
### 
...
readonly CASA_CONF_PATH=/etc/dappsteros.conf
readonly CASA_SERVICE_PATH=/etc/systemd/system/dappsteros.service
readonly CASA_HELPER_PATH=/usr/share/dappsteros/shell/
readonly CASA_USER_CONF_PATH=/var/lib/dappsteros/conf/
readonly CASA_DB_PATH=/var/lib/dappsteros/db/
readonly CASA_TEMP_PATH=/var/lib/dappsteros/temp/
...
Check_Exist() {
    ...
    ${sudo_cmd} rm -rf /usr/lib/systemd/system/dappsteros.service
    
    ${sudo_cmd} rm -rf /lib/systemd/system/dappsteros.service
